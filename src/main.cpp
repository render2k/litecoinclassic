...
uint256 hashGenesisBlock("0x4fd747b3d1ba132b89ea1d5b75485d78279c529594b4f5d164107326d7669be0");
...
const string strMessageMagic = "Litecoin Classic Signed Message:\n";
...
static const int64 nTargetTimespan = 2016 * 150; // Litecoin Classic: 3,5 days (2016 blocks)
static const int64 nTargetSpacing = 150; // Litecoin Classic: 2,5 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal litecoinclassic miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Litecoin Classic", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7311be121463fa9558ac54b2659cb0e3215055b93230b4015bf8c91ff28de51e");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Rumors about the death of the Vitalik Buterin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1498551385; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1623917;

        if (fTestNet)
        {
            block.nTime    = 1498487783;
            block.nNonce   = 1377919;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x3703937fb7fc99b07e1f32b0709159f168903716e65eb95efc947af0de100894"));
